...
Define the accepted long-lived governance baseline for the Claude agent standards template, including how OpenSpec, project boundaries, and repository validation work together.
