...
Use the project harness as the evidence engine for Symphony-ready delivery. Validation should be reproducible, tied to acceptance criteria, and ready to paste into `## Claude Workpad` and the PR.
...
- Destination: update `## Claude Workpad`, PR test plan, and Linear/PR attachments when the toolchain supports it.
