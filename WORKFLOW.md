...
14. Open and follow `.claude/skills/requesting-code-review/SKILL.md`, then before moving to `Human Review`, poll PR feedback and checks:
    ...
    - Archive the verified OpenSpec change with `.claude/skills/openspec-archive-change/SKILL.md` before requesting `Human Review`; unarchived changes fail the handoff gate.
